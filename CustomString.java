...
public class CustomString {
	...
	public String getString() {
		...
		if (this.myString == null || isSet == false) {
	...
	public String remove(String arg) {
		...
		//Checks if the string has been empty or null or it has not been set.
		...
		for (i = 0; i < this.myString.length(); ++i) {
			...
			for ( p = 0; p < arg.length(); ++p) {
				...
				if (Character.isLetter(arg.charAt(p))    &&  ( Character.toLowerCase(this.myString.charAt(i)) == Character.toLowerCase(arg.charAt(p)))) {
					 shouldRemove =  true;
					 break;
				}
			...
			if (shouldRemove == false) {
				newstring = newstring + this.myString.charAt(i);
			}
	...
	public String reverse(String arg) {
		...
		// TODO Implement method
				...
				for (i = 0; i < this.myString.length(); ++i) {
					...
					else if (Character.isUpperCase(this.myString.charAt(i))   ) {
					
						newstring = newstring + Character.toLowerCase(this.myString.charAt(i));
					}
					
					else if (Character.isLowerCase(myString.charAt(i))   ) {
						
						newstring = newstring + Character.toUpperCase(this.myString.charAt(i));
					}
	...
	public String filterLetters(char n, boolean more) {
		...
		for (i = 0; i < this.myString.length(); ++i) {
			...
			if (shouldRemove == false  ||  !Character.isLetter(this.myString.charAt(i))) {
